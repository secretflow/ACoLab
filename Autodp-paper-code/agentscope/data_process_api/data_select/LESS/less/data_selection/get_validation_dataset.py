...
def get_valid_dataset(data_dir: str,
                     tokenizer: PreTrainedTokenizerBase,
                     max_length: int,
    ...
    # import random
    # random.seed(42)
    # selected_elements = random.sample(data, 50)
    for subject in data:
        prompt = subject['conversations'][0]['value']
        answer = subject['conversations'][1]['value']
...
def get_dataset(task, **kwargs):
    ...
    if task == "bbh":
        ...
        return get_valid_dataset(**kwargs)
    else:
