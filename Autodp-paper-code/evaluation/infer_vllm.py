...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", type=str, default="/mnt/data3/nianke_multi_agent/model/qwen2_5_1_5b_ins/full/train_medical_sample_dirty/v4-20250503-175834/checkpoint-501")
    parser.add_argument("--model_type", type=str, default="qwen2_5")
    parser.add_argument("--test_data_path", type=str, default="qwen2_5")
    parser.add_argument("--output_path", type=str, default="qwen2_5")
    ...
    dataset = load_dataset([args.test_data_path], strict=False, shuffle=False)[0]
